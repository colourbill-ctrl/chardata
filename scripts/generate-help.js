...
// Strip the H1 title (shown separately) and contents block
const manualBody = manual
  .replace(/^#[^#].*\n+/, '')         // remove H1
  .replace(/^CharData is.*\n+/, '')   // remove subtitle paragraph
  .replace(/---[\s\S]*?---\n+/, '');  // remove TOC block (between first two ---)
  ...
  <nav>
    ...
    <ol>
      ...
      <li><a href="#4-explore-mode">Explore mode</a>
        <ol>
          <li><a href="#41-data-table">Data table</a></li>
          <li><a href="#42-g7-report">G7 report</a></li>
          <li><a href="#43-3d-gamut-plot">3D Gamut plot</a></li>
          <li><a href="#44-2d-gamut-slice">2D Gamut slice</a></li>
          <li><a href="#45-estimate-section">Estimate section</a></li>
        </ol>
      </li>
      <li><a href="#5-compare-mode">Compare mode</a>
        <ol>
          <li><a href="#51-compare-table">Compare table</a></li>
          <li><a href="#52-3d-gamut-plot-compare">3D Gamut plot (Compare)</a></li>
        </ol>
      </li>
